...
public class Runner {
    public static void main(String[] args) {
        homework3.ex1.Runner.main(null);
        System.out.println("______________");
        homework3.ex2.Runner.main(null);
        System.out.println("______________");
        homework3.ex3.Runner.main(null);
        System.out.println("______________");
        homework3.ex4.Runner.main(null);
        System.out.println("______________");
        homework3.ex5.Runner.main(null);
    }
