...
public class Runner {
    ...
    private static void ex1() throws URISyntaxException, IOException {
        LuggageBelt luggageBelt = new LuggageBelt();
        luggageBelt.handOverBaggage("luggage.csv");
    }

    private static void ex2() throws URISyntaxException, IOException {
        StatisticsCalculator statisticsCalculator = new StatisticsCalculator();
        System.out.println(statisticsCalculator.calculateStatistic("luggage.csv"));
    }
